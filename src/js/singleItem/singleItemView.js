export function render(object, isFaved){
    ...
    const markup = `<div class="container p-0 pt-5">
                        <div class="heading-1">
                            Квартира Студия, ${object.square} м2 за ${object.price_total} ₽
                        </div>
                            ...
                            <div class="modal">
                                <div class="modal__header">
                                    ...
                                    <div class="modal__details">
                                        Квартира <span>${object.flat_number}</span> в Первом квартале Дом ${object.building}
...
export function toggleFavoriteBtn(isFaved){
